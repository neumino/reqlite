...
Document.prototype.update = function(newValue, options, query, internalOptions) {
  ...
  if (util.isFunction(newValue)) {
    ...
    updatePromise = query.evaluate(newValue, internalOptions).then(function(result) {
      return result;
    }).catch(function(err) {
    ...
    updatePromise = query.evaluate(newValue, internalOptions).then(function(result) {
      if (typeof updateValue === 'function') {
        var updateValue = result(util.toDatum(self));
  ...
  return updatePromise.then(function(updateValue) {
