...
Query.prototype.evaluate = function(term, internalOptions) {
  ...
  if ((Array.isArray(term) === false) && (util.isPlainObject(term) === false)) {
    ...
    for(var i=0; i<keys.length; i++) {
      ...
      values.push(this.evaluate(term[keys[i]], internalOptions));
      this.frames.pop()
    }
  ...
  switch(termType) {
    ...
    case termTypes.HAS_FIELDS:
      ...
      return Promise.all(args).then(function(args) {
        var sequenceOrObject = args[0];
        var keys = args.slice(1);
        return self.hasFields(sequenceOrObject, keys);
      });
    case termTypes.WITH_FIELDS:
      ...
      return Promise.all(args).then(function(args) {
        var sequenceOrObject = args[0];
        var keys = new Sequence(args.slice(1));
        return self.withFields(sequenceOrObject, keys);
      });
    case termTypes.PLUCK:
      ...
      return Promise.all(args).then(function(args) {
        var sequenceOrObject = args[0];
        var keys = new Sequence(args.slice(1));
        return self.pluck(sequenceOrObject, keys);
      });
    case termTypes.WITHOUT:
      ...
      return Promise.all(args).then(function(args) {
        var sequenceOrObject = args[0];
        var keys = new Sequence(args.slice(1));
        return self.without(sequenceOrObject, keys);
      });
    case termTypes.MERGE:
      //TODO Test with Documents
      util.assertArityRange(1, Infinity, term[1], this);
      this.frames.push(0);
      var sequenceOrObject = this.evaluate(term[1].shift(), internalOptions);
      this.frames.pop();

      return Promise.resolve(sequenceOrObject).then(function(sequenceOrObject) {
        return self.merge(sequenceOrObject, term[1], internalOptions);
      });
    case termTypes.BETWEEN:
      ...
      return Promise.all([table, left, right, options]).then(function(args) {
        table = args[0];
        left = args[1];
        right = args[2];
        options = args[3];
        return self.between(table, left, right, options, internalOptions);
      });
    ...
    case termTypes.REDUCE:
      ...
      return Promise.resolve(sequence).then(function(sequence) {
        return self.reduce(sequence, term[1][1], internalOptions);
      });
    case termTypes.MAP:
      util.assertArityRange(2, Infinity, term[1], this);
      var sequences = []
      ...
      return Promise.all(sequences).then(function(sequences) {
        return self.map(sequences, term[1][term[1].length-1], internalOptions);
      });
    case termTypes.FILTER:
      ...
      var sequence = this.evaluate(term[1][0], internalOptions);
      this.frames.pop();
      return Promise.all([sequence, options]).then(function(args) {
        sequence = args[0];
        options = args[1];
        return self.filter(sequence, term[1][1], options, internalOptions);
      });
    case termTypes.CONCAT_MAP: // 40
      util.assertArity(2, term[1], this);
      var sequence = this.evaluate(term[1][0], internalOptions);
      return Promise.resolve(sequence).then(function(sequence) {
        return self.concatMap(sequence, term[1][1], internalOptions);
      });
    case termTypes.ORDER_BY:
      this.frames.push(0);
      var sequence = this.evaluate(term[1].shift(), internalOptions);
      // Do not copy as we want to keep the selection type
      this.frames.pop();

      return Promise.all([sequence, options]).then(function(args) {
        return self.orderBy(sequence, term, options, internalOptions);
      });
    ...
    case termTypes.COUNT:
      ...
      return Promise.resolve(sequenceOrBin).then(function(sequenceOrBin) {
        return self.count(sequenceOrBin, term[1][1], internalOptions);
      });
    case termTypes.IS_EMPTY:
      ...
      this.frames.pop();
      return Promise.resolve(sequence).then(function(sequence) {
        return self.isEmpty(sequence);
      });
    case termTypes.UNION:
      util.assertArityRange(1, Infinity, term[1], this);
      var sequences = [];
      this.frames.push(0);
      sequences.push(this.evaluate(term[1][0], internalOptions))
      this.frames.pop();

      for(var i=1; i<term[1].length; i++) {
        this.frames.push(i);
        sequences.push(this.evaluate(term[1][i], internalOptions))
        this.frames.pop();
      }
      return Promise.all(sequences).then(function(sequences) {
        return self.union(sequences);
      });
    case termTypes.NTH:
      util.assertArity(2, term[1], this);
      this.frames.push(0);
      ...
      this.frames.pop();
      return Promise.all([sequence, index]).then(function(args) {
        return self.nth.apply(self, args);
      });
    case termTypes.BRACKET:
      ...
      return Promise.all([sequence, key]).then(function(args) {
        return self.bracket.apply(self, args);
      });
    case termTypes.INNER_JOIN:
      ...
      return Promise.all([sequence, otherSequence]).then(function(args) {
        sequence = args[0];
        otherSequence = args[1];
        return self.join('inner', sequence, otherSequence, term[1][2], internalOptions);
      });
    case termTypes.OUTER_JOIN:
      ...
      return Promise.all([sequence, otherSequence]).then(function(args) {
        sequence = args[0];
        otherSequence = args[1];
        return self.join('outer', sequence, otherSequence, term[1][2], internalOptions);
      });
    case termTypes.EQ_JOIN:
      ...
      return Promise.all([sequence, rightTable, options]).then(function(arg) {
        return self.eqJoin(sequence, rightTable, term[1][1], options, internalOptions);
      });
    case termTypes.ZIP:
      util.assertArity(1, term[1], this);
      this.frames.push(0);
    ...
    case termTypes.RANGE:
      ...
      return Promise.all([start, end]).then(function(args) {
        return self.range.apply(self, args);
      });
    case termTypes.INSERT_AT:
      ...
      Promise.all([sequence, position, value]).then(function(args) {
        return self.insertAt.apply(self, args);
      });
    case termTypes.DELETE_AT:
      ...
      Promise.all([sequence, start, end]).then(function(args) {
        return self.deleteAt.apply(self, args);
      });
    case termTypes.CHANGE_AT:
      ...
      Promise.all([sequence, position, value]).then(function(args) {
        return self.changeAt.apply(self, args);
      });
    case termTypes.SPLICE_AT:
      ...
      Promise.all([sequence, position, other]).then(function(args) {
        return self.spliceAt.apply(self, args);
      });
    case termTypes.COERCE_TO:
      ...
      return Promise.all([value, newType]).then(function(args) {
        return self.coerceTo.apply(self, args);
      });
    ...
    case termTypes.UPDATE:
      ...
      return Promise.resolve([selection, term[1][1], options, internalOptions]).then(function(args) {
    ...
    case termTypes.DELETE:
      ...
      var selection = this.evaluate(term[1][0], internalOptions)
      this.frames.pop();
      return Promise.resolve(selection).then(function(selection) {
        return self.delete(selection, options);
      });
    case termTypes.REPLACE:
      ...
      return Promise.all([selection, term[1][1], options, internalOptions]).then(function(args) {
        return self.replace.apply(self, args);
      });
    case termTypes.INSERT:
      ...
      return Promise.all([table, docs, options]).then(function(args) {
        return self.insert.apply(self, args);
      });
    ...
    case termTypes.TABLE_CREATE:
      ...
      return Promise.all([db, tableName, dbProvided, options]).then(function(args) {
        return self.tableCreate.apply(self, args);
      });
    case termTypes.TABLE_DROP:
      ...
      return Promise.all([db, tableName, dbProvided]).then(function(args) {
        return self.tableDrop.apply(self, args);
      });
    case termTypes.TABLE_LIST:
      ...
      return Promise.all([db, dbProvided]).then(function(args) {
        return self.tableList.apply(self, args);
      });
    case termTypes.SYNC:
      util.assertArity(1, term[1], this);
      this.frames.push(0);
      var table = this.evaluate(term[1][0], internalOptions);
      this.frames.pop();
      return Promise.resolve(table).then(function(table) {
        return self.sync(table);
      });
    case termTypes.INDEX_CREATE:
      ...
      return Promise.all([table, name, term[1][2], options]).then(function(args) {
        return self.indexCreate.apply(self, args);
      });
    case termTypes.INDEX_DROP:
      ...
      var index = this.evaluate(term[1][1], internalOptions);
      this.frames.pop();
      return Promise.all([table, index]).then(function(args) {
        return self.indexDrop.apply(self, args);
      });
    case termTypes.INDEX_LIST:
      ...
      var table = this.evaluate(term[1][0], internalOptions);
      this.frames.pop();
      return Promise.resovle(table).then(function(table) {
        return self.indexList(table);
      });
    case termTypes.INDEX_RENAME:
      ...
      Promise.all([table, oldIndex, newIndex, options]).then(function(args) {
        return self.indexRename.apply(self, args);
      });
    case termTypes.INDEX_STATUS:
      ...
      Promise.all([table, Promise.all(indexes)]).then(function(args) {
        return self.indexStatus.apply(self, args);
      });
    case termTypes.INDEX_WAIT:
      ...
      Promise.all([table, Promise.all(indexes)]).then(function(args) {
        return self.indexWait.apply(self, args);
      });
    case termTypes.FUNCALL:
      // FUNCALL, FN [ AR[], BODY]
      //  0       1  [ 0 [ ...], 
      util.assertArityRange(1, Infinity, term[1], this);
      var argsFn = util.getVarId(fn);

      var context = [];
      for(var i=1; i<term[1].length; i++) {
        this.frames.push(i);
        util.assertPreDatum(term[1][i], this);
        context.push(this.evaluate(term[1][i], internalOptions));
        this.frames.pop();
      }
      ...
      return Promise.all([Promise.all(context), argsFn, term[1][0]]).then(function(context) {
        self.funcall(context, argsFn, fn);
      });
    case termTypes.BRANCH:
      ...
      return Promise.resolve(condition).then(function(condition) {
        return self.branch(condition, term[1][1], term[1][2], internalOptions)
      });
    case termTypes.OR:
      util.assertArityRange(1, Infinity, term[1], this);
      return this.or(undefined, term[1], 0, internalOptions);
    case termTypes.AND:
      util.assertArityRange(1, Infinity, term[1], this);
      return this.and(undefined, term[1], 0, internalOptions);
    case termTypes.FOR_EACH:
      util.assertArity(2, term[1], this);
      this.frames.push(0);
      var sequence = this.evaluate(term[1][0], internalOptions);
      this.frames.pop();
      Promise.resolve(sequence).then(function(sequence) {
        return self.forEach(sequence);
      });
    ...
    case termTypes.INFO:
      ...
      return Promise.resolve(element).then(function(element) {
    ...
    case termTypes.MATCH:
      ...
      return Promise.all([str, regexRaw]).then(function(args) {
        return self.match.apply(self, args);
      });
    case termTypes.UPCASE:
      ...
      this.frames.pop();
      return Promise.resolve(str).then(function(str) {
        return self.upCase(str);
      });
    ...
    case termTypes.SAMPLE:
      ...
      this.frames.pop()
      return Promise.all([sequence, sample]).then(function(args) {
        return self.sample.apply(self, args);
      });
    case termTypes.DEFAULT:
      ...
      // We don't want to follow the usual promise chain here.
    ...
    case termTypes.TO_JSON_STRING:
      ...
      this.frames.pop();
      return Promise.resolve(value).then(function(value) {
        return self.toJsonString(value);
      });
    case termTypes.ISO8601: // 99
      ...
      this.frames.pop();
      return Promise.resolve(date).then(function(date) {
        return self.ISO8601(date)
      });
    ...
    case termTypes.EPOCH_TIME:
      ...
      this.frames.pop();
      return Promise.resolve(epochTime).then(function(epochTime) {
        return self.epochTime(epochTime)
      });
    ...
    case termTypes.IN_TIMEZONE:
      ...
      return Promise.all([date, timezoneStr]).then(function(date) {
        return self.inTimezone(date, timezone)
      });
    case termTypes.DURING:
      ...
      return Promise.all([date, left, right]).then(function(args) {
        return self.during.apply(self, args)
      });
    case termTypes.DATE:
      util.assertArity(1, term[1], this);
      this.frames.push(0);
    ...
    case termTypes.TIME: // 136
      ...
      Promise.all([year, month, day, hours, minutes, seconds, milliseconds, timezone]).then(function(args) {
        return self.time.apply(self, args);
      });
    ...
    case termTypes.GROUP:
      ...
      Promise.all([group, term, options, internalOptions]).then(function(args) {
        return self.group.apply(self, args);
      });
    ...
    case termTypes.SUM:
      ...
      return Promise.all([sequence, term[1][1], internalOptions]).then(function(args) {
        return self.sum.apply(self, args);
      });
    case termTypes.AVG:
      util.assertArityRange(1, 2, term[1], this);
      this.frames.push(0);
      ...
      return Promise.all([sequence, mapper, internalOptions]).then(function(args) {
        return self.sum.apply(self, args);
      });
    case termTypes.MIN:
      ...
      return Promise.all([sequence, mapper, options, internalOptions]).then(function(args) {
        return self.min.apply(self, args);
      });
    case termTypes.MAX:
      // Arity check is performed inside the function
      this.frames.push(0);
      ...
      return Promise.all([sequence, mapper, options, internalOptions]).then(function(args) {
        return self.max.apply(self, args);
      });
    case termTypes.SPLIT:
      ...
      return Promise.all([str, separator, limit]).then(function(args) {
        return self.split.apply(self, args);
      });
    ...
    case termTypes.RANDOM:
      ...
      return Promise.all([min, max, options]).then(function(args) {
        return self.random.apply(self, args);
      });
    case termTypes.CHANGES:
      ...
      this.frames.pop();
      return Promise.resolve(tableSlice).then(function(tableSlice) {
        return self.changes(tableSlice)
      });
    case termTypes.ARGS:
      util.isBuggy(this);
    case termTypes.POINT:
      ...
      return Promise.all([longitude, latitude]).then(function(args) {
        return self.point.apply(self, args);
      });
    case termTypes.CIRCLE:
      ...
      return Promise.all([center, radius, options]).then(function(args) {
        return self.circle.apply(self, args);
      });
    case termTypes.LINE:
      util.assertArityRange(2, Infinity, term[1], this);
      var coordinates = [];
      ...
      return Promise.all(coordinates).then(function(args) {
        return self.line.apply(self, args);
      });
    case termTypes.FILL:
      util.assertArity(1, term[1], this);
      this.frames.push(0);
      ...
      return Promise.resolve(line).then(function(line) {
    ...
    case termTypes.GEOJSON:
      ...
      this.frames.pop();
      return Promise.resolve(geojson).then(function(geojson) {
    ...
    case termTypes.TO_GEOJSON:
      ...
      this.frames.pop();
      return Promise.resolve(geometry).then(function(geometry) {
        return self.toGeojson(geometry);
      });
    case termTypes.GET_INTERSECTING:
      ...
      this.frames.pop();
      return Promise.all([table, geometry, options, internalOptions]).then(function(args) {
        return self.getIntersecting.apply(self, args);
      });
    case termTypes.GET_NEAREST:
      ...
      return Promise.all([table, geometry, options, internalOptions]).then(function(args) {
        return self.getNearest.apply(self, args);
      });
    case termTypes.INCLUDES:
      ...
      this.frames.pop();
      return Promise.all([geometry1, geometry2]).then(function(args) {
        return self.includes.apply(self, args);
      });
    case termTypes.INTERSECTS:
      ...
      this.frames.pop();
      return Promise.all([geometry1, geometry2]).then(function(args) {
        return self.intersects.apply(self, args);
      });
    case termTypes.POLYGON:
      ...
      return Promise.all(coordinates).then(function(coordinates) {
    ...
    case termTypes.POLYGON_SUB:
      ...
      return Promise.all([outerPolygon, innerPolygon]).then(function(args) {
        return self.polygonSub.apply(self, args);
      });
    case termTypes.DISTANCE:
      ...
      return Promise.all([from, to]).then(function(args) {
        return self.distance.apply(self, args);
      });
...
Query.prototype.comparator = function(comparator, reference, value, left, index, internalOptions) {
  console.log(comparator, reference, value, left, index, internalOptions)
  var self = this;
...
Query.prototype.hasFields = function(sequenceOrObject, keys) {
  this.frames.push(0);
  ...
  for(var i=0; i<keys.length; i++) {
    ...
    util.assertType(keys[i], 'DATUM', this);
    this.frames.pop();
  }
...
Query.prototype.withFields = function(sequenceOrObject, keys) {
  this.frames.push(0);
  if (!util.isObject(sequenceOrObject) && !util.isSequence(sequenceOrObject)) {
    util.cannotPerformOp('with_fields', util.toDatum(sequenceOrObject), this);
  }
  this.frames.pop();
  ...
  if (typeof sequenceOrObject.withFields === 'function') {
    return sequenceOrObject.withFields(keys);
  }
  else {
    return util.withFields(sequenceOrObject, keys);
  }
}

Query.prototype.pluck = function(sequenceOrObject, keys) {
  if (!util.isObject(sequenceOrObject) && !util.isSequence(sequenceOrObject)) {
...
Query.prototype.merge = function(sequenceOrObject, toMerge, internalOptions) {
  this.frames.push(0);
  if (!util.isObject(sequenceOrObject) && !util.isSequence(sequenceOrObject)) {
  ...
  for(var i=0; i<toMerge.length; i++) {
    if (typeof sequenceOrObject.merge === 'function') {
      sequenceOrObject = sequenceOrObject.merge(toMerge[i], this);
    }
    else {
      sequenceOrObject = util.merge(sequenceOrObject, toMerge[i], this, internalOptions);
    }
  }
  return sequenceOrObject;
}

Query.prototype.between = function(table, left, right, options, internalOptions) {
...
Query.prototype.reduce = function(sequence, reducer, internalOptions) {
  util.toSequence(sequence, this);
  return sequence.reduce(reducer, this, internalOptions);
}

Query.prototype.map = function(sequences, mapper) {
  ...
  if ((sequences.length === 1) && util.isChanges(sequences[0])) {
    return sequences[0].map(mapper, this, internalOptions)
  }
  return Sequence.map(sequences, mapper, this, internalOptions);
}

Query.prototype.filter = function(sequence, predicate, options, internalOptions) {
  // Do not reassign here as we want to keep selections
  util.toSequence(sequence, this);
  return sequence.filter(predicate, options, this, internalOptions);
}

Query.prototype.concatMap = function(sequence, mapper, internalOptions) {
  util.toSequence(sequence, this);
  return sequence.concatMap(mapper, this, internalOptions);
}
Query.prototype.orderBy = function(sequence, fields, options, internalOptions) {
...
Query.prototype.count = function(sequenceOrBin, predicate, internalOptions) {
...
Query.prototype.isEmpty = function(sequence) {
  util.toSequence(sequence, this);
  return sequence.isEmpty(this);
}

Query.prototype.union = function(sequences) {
  var result = new Sequence();
  for(var i=0; i<sequences.length; i++) {
    util.toSequence(sequences[i], this);
    result = result.concat(sequences[i]);
  }
  return result;
}

Query.prototype.nth = function(sequence, index) {
  util.toSequence(sequence, this);
  util.assertType(index, "NUMBER", this);
  return sequence.nth(index, this);
}

Query.prototype.bracket = function(sequence, key) {
  this.frames.push(0);
  if (!util.isObject(sequenceOrObject) && !util.isSequence(sequenceOrObject)) {
  ...
  return util.getBracket(sequenceOrObject, key, this);
}

// innerJoin and outerJoin
Query.prototype.join = function(type, sequence, otherSequence, predicate, internalOptions) {
  util.toSequence(sequence, this);
  otherSequence = util.toSequence(otherSequence, this);
  return sequence.join(type, otherSequence, term[1][2], this, internalOptions);
}

Query.prototype.eqJoin = function(sequence, rightTable, leftField, options, internalOptions) {
  util.toSequence(sequence, this);
  util.assertType(rightTable, 'TABLE', this);
  return sequence.eqJoin(leftField, rightTable, options, this, internalOptions);
}

Query.prototype.zip = function(sequence) {
  util.toSequence(sequence, this);
...
Query.prototype.insertAt = function(sequence, position, value) {
  this.frames.push(0);
  util.assertType(sequence, 'DATUM', this);
  this.frames.pop();
  util.assertType(sequence, 'ARRAY', this);
  ...
  //TODO Check value is a datum?
  return sequence.insertAt(position, value, this);
}


Query.prototype.deleteAt = function(sequence, position, value) {
  util.assertArityRange(2, 3, term[1], this);
  this.frames.push(0);
  util.assertType(sequence, 'DATUM', this);
  this.frames.pop();
  ...
  if (end !== undefined) {
    this.frames.push(2);
    //TODO Add test for the next assert
    util.assertType(end, 'NUMBER', this);
    this.frames.pop();
  }
...
Query.prototype.changeAt = function(sequence, position, value) {
  this.frames.push(0);
  util.assertType(sequence, 'DATUM', this);
  this.frames.pop();
  util.assertType(sequence, 'ARRAY', this);
...
Query.prototype.spliceAt = function(sequence, position, other) {
  this.frames.push(0);
  util.assertType(sequence, 'DATUM', this);
  this.frames.pop();
  util.assertType(sequence, 'ARRAY', this);
...
Query.prototype.coerceTo = function(value, newType) {
  this.frames.push(1);
  util.assertType(newType, 'STRING', this);
  this.frames.pop();
  newType = newType.toUpperCase();
...
Query.prototype.typeOf = function(value) {
  util.assertArity(1, term[1], this);
  this.frames.push(0);
...
Query.prototype.update = function(selection, predicate, options, internalOptions) {
  this.frames.push(0);
  util.assertType(selection, 'SELECTION', this);
  this.frames.pop();
  return selection.update(predicate, options, this, internalOptions)
}

Query.prototype.delete = function(selection, options) {
  this.frames.push(0);
  util.assertType(selection, 'SELECTION', this);
  this.frames.pop();
...
Query.prototype.replace = function(selection, predicate, options, internalOptions) {
  util.assertArity(2, term[1], this);
  this.frames.push(0);
  util.assertType(selection, 'SELECTION', this);
  this.frames.pop();

  return selection.replace(predicate, options, this, internalOptions);
}

Query.prototype.insert = function(table, docs, options) {
  this.frames.push(0);
  util.assertType(table, 'TABLE', this);
  this.frames.pop();
...
Query.prototype.dbCreate = function(dbName) {
  this.frames.push(0);
  util.assertType(dbName, 'STRING', this);
  util.assertNoSpecialChar(dbName, 'Database', this);
  this.frames.pop();
...
Query.prototype.dbDrop = function(dbName) {
  this.frames.push(0)
  util.assertType(dbName, 'STRING', this);
  util.assertNoSpecialChar(dbName, 'Database', this);
  this.frames.pop();
...
Query.prototype.tableCreate = function(db, tableName, dbProvided, options) {
  util.assertOptions(options, ['primary_key', 'durability', 'shards', 'replicas', 'primary_replica_tag'], this);
  var db, tableName;
  if (dbProvided) {
    this.frames.push(0);
...
Query.prototype.tableDrop = function(db, tableName, dbProvided) {
  if (dbProvided === true) {
    this.frames.push(0);
    util.assertType(db, 'DATABASE', this);
    this.frames.pop();
...
Query.prototype.tableList = function(db, dbProvided) {
  //TODO Check type?
  return new Sequence(Object.keys(db.tables));
}

Query.prototype.sync = function(table) {
  util.assertType(table, 'TABLE', this);
  return {synced: 1}
}

Query.prototype.indexCreate = function(table, name, predicate, options) {
  this.frames.push(0);
  util.assertType(table, 'TABLE', this);
  this.frames.pop();
  ...
  //TODO Move {created: 1} in table.indexCreate
  return {created: 1}
}

Query.prototype.indexDrop = function(table, name) {
  this.frames.push(0);
  util.assertType(table, 'TABLE', this);
  this.frames.pop();
  this.frames.push(1);
...
Query.prototype.indexList = function(table, name) {
  this.frames.push(0);
  util.assertType(table, 'TABLE', this);
  this.frames.pop();
...
Query.prototype.indexRename = function(table, oldIndex, newIndex, options) {
  this.frames.push(0);
  util.assertType(table, 'TABLE', this);
  this.frames.pop();
  this.frames.push(1);
...
Query.prototype.indexStatus = function(table, indexes) {
  this.frames.push(0);
  util.assertType(table, 'TABLE', this);
  this.frames.pop();
  ...
  for(var i=0; i<indexes.length; i++) {
    this.frames.push(i);
    util.assertType(indexes[i], 'STRING', this);
    this.frames.pop();
  }
  ...
  try {
    ...
    //TODO Move this in indexWait
    throw new Error.ReqlRuntimeError(err.message, this.frames)
  }
}
Query.prototype.indexWait = Query.prototype.indexStatus;

Query.prototype.funcall = function(context, argsFn, fn) {
  // RethinkDB use the internal syntax r.do(fn, args...) -_-{
  var self = this;
  for(var i=0; i<context.length; i++) {
    util.assertType(context[i], 'DATUM', this);
    this.context[argsFn[i]] = context[i];
  }
...
Query.prototype.branch = function(condition, rightBranch, falseBranch, internalOptions) {
  this.frames.push(0);
  ...
  if (condition === false || condition === null) {
    if (util.isFunction(falseBranch)) {
      throw new Error.ReqlRuntimeError("Query result must be of type DATUM, GROUPED_DATA, or STREAM (got FUNCTION)", this.frames)
    }
    this.frames.push(2);
    result = this.evaluate(falseBranch, internalOptions);
    this.frames.pop();
  }
  else {
    if (util.isFunction(rightBranch)) {
      throw new Error.ReqlRuntimeError("Query result must be of type DATUM, GROUPED_DATA, or STREAM (got FUNCTION)", this.frames)
    }
    this.frames.push(1);
    result = this.evaluate(rightBranch, internalOptions);
    this.frames.pop();
  }
  return result;
}

Query.prototype.or = function(bool, left, index, internalOptions) {
  var self = this;
  if (bool !== undefined) {
    this.frames.push(index-1);
  ...
  if (left.length > 0) {
    this.frames.push(index);
    var newTerm = left.shift();
    util.assertPreDatum(newTerm, this);
    bool = this.evaluate(newTerm, internalOptions);
    this.frames.pop();

    return Promise.resolve(bool).then(function(bool) {
      return self.or(bool, left, index+1, internalOptions);
    });
  }
  else {
    return false;
...
Query.prototype.and = function(bool, left, index, internalOptions) {
  var self = this;
  if (bool !== undefined) {
    this.frames.push(index-1);
    util.assertType(bool, 'DATUM', this);
  ...
  if (left.length > 0) {
    ...
    return Promise.resolve(bool).then(function(bool) {
      return self.and(bool, left, index+1, internalOptions);
    });
  }
  else {
    return bool;
...
Query.prototype.forEach = function(sequence) {
  util.toSequence(sequence, this);
  return sequence.forEach(term[1][1], this, internalOptions);
}

Query.prototype.info = function(element) {
...
Query.prototype.match = function(str, regexRaw) {
  util.assertType(str, "STRING", this);
...
Query.prototype.upCase = function(str) {
  var result = '';
...
Query.prototype.downCase = function(str) {
  var result = '';
  for(var i=0; i<str.length; i++) {
...
Query.prototype.sample = function(sequence, sample) {
  util.toSequence(sequence, this);
  util.assertType(sample, 'NUMBER', this);
  return sequence.sample(sample, this);
}

Query.prototype.json = function(str) {
  this.frames.push(0);
  util.assertType(str, "STRING", this);
  this.frames.pop();
  try {
...
Query.prototype.toJsonString = function(value) {
  this.frames.push(0);
  util.assertType(value, 'DATUM', this);
  this.frames.pop();
  return JSON.stringify(util.toDatum(value));
...
Query.prototype.ISO8601 = function(date) {
  this.frames.push(0);
...
Query.prototype.ToISO8601 = function(date) {
  this.frames.push(0);
...
Query.prototype.epochTime = function(epochTime) {
  this.frames.push(0);
...
Query.prototype.toEpochTime = function() {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
...
Query.prototype.inTimezone = function(date, timezoneStr) {
...
Query.prototype.during = function(date, timezoneStr) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  date = date.toMoment();
  this.frames.pop();
...
Query.prototype.date = function(date) {
  util.assertTime(date, this);
...
Query.prototype.timeOfDay = function(date) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
...
Query.prototype.timezone = function(date) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
...
Query.prototype.year = function(date) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
  momentDate = date.toMoment();
...
Query.prototype.month = function(date) {
...
Query.prototype.day = function(date) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
...
Query.prototype.dayOfWeek = function(date) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
...
Query.prototype.dayOfYear = function(date) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
...
Query.prototype.hours = function(date) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
...
Query.prototype.minutes = function(date) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
...
Query.prototype.seconds = function(date) {
  this.frames.push(0);
  util.assertTime(date, this, true);
  this.frames.pop();
...
Query.prototype.time = function(year, month, day, hours, minutes, seconds, milliseconds, timezone) {
  this.frames.push(0);
...
Query.prototype.group = function(fieldOrFns, options, internalOptions) {
  util.toSequence(sequence, this);
  if ((fieldOrFns.length === 0) && (typeof options.index !== 'string')) {
...
Query.prototype.sum = function(sequence, mapper, internalOptions) {
  //TODO Enforce sequence type?
  return sequence.sum(mapper, this, internalOptions);
}

Query.prototype.avg = function(sequence, mapper, internalOptions) {
  //TODO Enforce sequence type?
  return sequence.avg(mapper, this, internalOptions);
}

Query.prototype.min = function(sequence, mapper, options, internalOptions) {
  var extra = (typeof options.index === 'string') ? [options] : [];
  util.assertArityRange(1, 2, term[1].concat(extra), this);
  return sequence.min(mapper, options, this, internalOptions);
}

Query.prototype.max = function(sequence, mapper, options, internalOptions) {
  var extra = (typeof options.index === 'string') ? [options] : [];
  util.assertArityRange(1, 2, term[1].concat(extra), this);
  return sequence.max(mapper, options, this, internalOptions);
}

Query.prototype.split = function(str, separator, limit) {
  this.frames.push(0);
  util.assertType(str, "STRING", this);
  this.frames.pop();
  ...
  else if (separator !== null) { // RethinkDB doesn't frame that...
...
Query.prototype.ungroup = function(groups) {
  util.assertType(groups, "GROUP", this);
  return groups.ungroup();
}

Query.prototype.random = function(min, max, options) {
...
Query.prototype.changes = function(tableSlice) {
  return new Changes(tableSlice, this)
}

Query.prototype.point = function(longitude, latitude) {
...
Query.prototype.circle = function(center, radius, options) {
...
Query.prototype.line = function(coordinates) {
  for(var i=0; i<coordinates.length; i++) {
  if (util.isGeometry(coordinates[i])) {
    coordinates[i] = coordinates[i].coordinates;
  }
  else {
    util.assertPointCoordinates(coordinates[i], this);
    //TODO Do not convert to datum
    coordinates.push(util.toDatum(coordinates[i]));
    }
  }
  return new ReqlGeometry('LineString', coordinates, this);
}

Query.prototype.fill = function(line) {
...
Query.prototype.geojson = function(geojson) {
  return ReqlGeometry.geojson(geojson, this);
}

Query.prototype.toGeojson = function(geometry) {
  return geometry.toGeojson(this);
}

Query.prototype.getIntersecting = function(table, geometry, options, internalOptions) {
  this.frames.push(0);
  util.assertType(table, 'TABLE', this);
  this.frames.pop();
  this.frames.push(1);
...
Query.prototype.getNearest = function(table, geometry, options, internalOptions) {
  this.frames.push(0);
  util.assertType(table, 'TABLE', this);
  this.frames.pop();
...
Query.prototype.includes = function(geometry1, geometry2) {
  this.frames.push(0);
...
Query.prototype.intersects = function(geometry1, geometry2) {
  this.frames.push(0);
  if (!util.isGeometry(geometry1) && !util.isSequence(geometry1)) {
...
Query.prototype.polygon = function(coordinates) {
  var coordinates = [];
  for(var i=0; i<coordinates.length; i++) {
    this.frames.push(i);
...
Query.prototype.polygonSub = function(outerPolygon, innerPolygon) {
  util.assertArity(2, term[1], this);
  this.frames.push(0);
...
Query.prototype.distance = function(from, to) {
  this.frames.push(0);
