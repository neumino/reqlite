...
Query.prototype.run = function(query) {
    ...
    try {
        ...
        // SHould just do some duck typing?
        if ((result instanceof Document)
            ...
            //console.log("CONVERTING", util.inspect(result, {depth: null}));
            result = result.toDatum();
        }
        else {
...
Query.prototype.evaluate = function(term) {
    console.log("TERM", util.inspect(term, {depth: null}))
    ...
    // TODO Should we evaluate that? or should we just consider that it's an object?
    var options = term[2] || {};
    ...
    switch(termType) {
        ...
        case termTypes.NOT:
            var bool = this.evaluate(term[1][0]);
