...
Changes.prototype.offsetsOf = function(predicate, query) {
  ...
  var offset = 0;
  self.postMethods.push(function(sequence) {
    var result = sequence.offsetsOf(predicate, query);
...
Changes.prototype.getInitialResponse = function() {
  ...
  if (this.type === 'document') {
    return this.table.get(this.primaryKeyValue).then(function(doc) {
...
Changes.createListener = function(self) {
  return function(change) {
    ...
    // Apply transformation
      Promise.reduce(self.preMethods, function(result, method) {
        return method(result).then(function(partial) {
          return partial;
        });
